...
public class Call {
    ...
    public Call(String agent_id, int customer_id, LocalTime call_at, LocalTime pick_up_at, LocalTime tranfer_at, LocalTime hangup_at, String status, String spin_call) {
